...
Локальное решение для автоматического распознавания ценников супермаркета «Лента» из видеопотока робота. Хакатон **Lenta Tech Life Hack**, трек «Полка под контролем».
...
| Компонент | Лицензия |
| --- | --- |
| Ultralytics YOLOv8 | AGPL-3.0 (заменяемо на YOLO-NAS / RT-DETR при коммерческом запрете) |
| Qwen2-VL-2B-Instruct | Apache 2.0 |
| pyzbar / OpenCV / Streamlit | BSD / Apache 2.0 / Apache 2.0 |
